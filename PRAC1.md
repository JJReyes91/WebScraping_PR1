...
- **A largo plazo**: Es la **visual utilizada para responder al objetivo planteado en la práctica**, conocer como ha evolucionado el valor de los carburantes, cual está siendo su tendencia (esta creciendo constantemente, uno crece más que el otro,...) o por ejemplo verificar si existen cambios de tendencia (¿a sido siempre más cara la gasolina que el diesel?).
