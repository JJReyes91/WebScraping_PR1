...
## Inspiración
El motivo de escoger esta temática se debe a que es un tema que afecta a todo el mundo ya que todos, en mayor o menor medida, somos consumidores de este recurso. Como causa del constante cambio de su valor es complejo tener una visibilidad clara de cómo ha ido evolucionando, lo que acaba derivando en únicamente una apreciación de si sube o bajo respecto al valor anterior, perdiondo así la visual de que tendencia está teniendo o si el diferencial entre las variaciones de valor negativas y positivas tienden, en un cómputo general, hacia arriba o hacia abajo.
